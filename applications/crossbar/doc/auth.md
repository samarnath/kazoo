...
#### Reset System Identity secret

System secret is the cryptography key which together with the user/account identity secret is used to encrypt the identitifier of the client for the token is being issued. This encrypted signature is used later to securely verfiying the identity of who is claiming to be the authorized user the token is generated for.
